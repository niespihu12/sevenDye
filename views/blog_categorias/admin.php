...
<main class="dashboard__content">
    <div class="influencers">
        ...
        <div class="influencers__header">
            ...
            <a href="/blog_categories/create" class="influencers__nuevo">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="influencers__acciones">
                                <form method="POST" action="/blog_categories/delete">
                                ...
                                <a href="/blog_categories/update?id=<?php echo $categoria->id; ?>" class="boton-actualizar">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
