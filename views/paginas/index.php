        ...
        <div class="carousel-container">
            <div class="carousel-track">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <picture>
                            <source srcset="./build/img/chaqueta1.avif" type="image/avif">
                            <source srcset="./build/img/chaqueta1.webp" type="image/webp">
                            <img loading="lazy" width="100" height="100" src="./build/img/chaqueta1.png"
                                alt="Sugary Bliss Denim Jacket">
                        </picture>
                        <div class="quick-actions">
                            <button class="favorite" aria-label="Add to favorites">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price">$102.40</div>
                ...
                <div class="product-card">
                    <div class="product-image">
                        <picture>
                            ...
                            <source srcset="./build/img/chaqueta3.webp" type="image/webp">
                            <img loading="lazy" width="100" height="100" src="./build/img/chaqueta3.png"
                                alt="Midnight Mirage Denim Jacket">
                        </picture>
                        <div class="quick-actions">
                            <button class="favorite" aria-label="Add to favorites">
                                <i class="far fa-heart"></i>
                ...
                <div class="product-card">
                    <div class="product-image">
                        <picture>
                            ...
                            <source srcset="./build/img/chaqueta1.webp" type="image/webp">
                            <img loading="lazy" width="100" height="100" src="./build/img/chaqueta1.png"
                                alt="Rainbow Dream Denim Jacket">
                        </picture>
                        <div class="quick-actions">
                            <button class="favorite" aria-label="Add to favorites">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-info">
                        <h3 class="product-title">
                            <a href="#">Rainbow Dream Denim Jacket T-Shirt Seven Best Tiedye Colorful</a>
                        </h3>
                        <div class="product-price">$102.40</div>
                        <div class="product-rating">
                            <div class="stars">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h3 class="product-title">
                            <a href="#">Cosmic Wave Denim Jacket T-Shirt Seven Best Tiedye Colorful</a>
                        </h3>
                        <div class="product-price">$102.40</div>
                        <div class="product-rating">
                            <div class="stars">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <picture>
                            ...
                            <source srcset="./build/img/chaqueta3.webp" type="image/webp">
                            <img loading="lazy" width="100" height="100" src="./build/img/chaqueta3.png"
                                alt="Aurora Lights Denim Jacket">
                        </picture>
                        <div class="quick-actions">
                            <button class="favorite" aria-label="Add to favorites">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-info">
                        <h3 class="product-title">
                            <a href="#">Aurora Lights Denim Jacket T-Shirt Seven Best Tiedye Colorful</a>
                        </h3>
                        <div class="product-price">$102.40</div>
                        <div class="product-rating">
                            <div class="stars">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h3 class="product-title">
                            <a href="#">Galaxy Burst Denim Jacket T-Shirt Seven Best Tiedye Colorful</a>
                        </h3>
                        <div class="product-price">$102.40</div>
                        <div class="product-rating">
                            <div class="stars">
