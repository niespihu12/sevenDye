...
<section class="nosotros-redes">
  <h3 class="centrar-texto">We are constantly launching new <br>items; join our community:</h3>
  <ul class="wrapper">
    ...
    <li class="icon tiktok">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" height="25" fill="currentColor" class="bi bi-tiktok"
        viewBox="0 0 16 16">
        <path
    ...
    <li class="icon email">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" height="30" fill="currentColor" class="bi bi-envelope"
        viewBox="0 0 16 16">
        <path
