...
<main>
    ...
    <div class="influencers">
        ...
        <div class="influencers__header">
            <h2>Testimonios</h2>
            <a href="/testimonios/crear" class="influencers__nuevo">
            ...
            <tbody>
                <?php foreach ($testimonios as $testimonio) { ?>
                    <tr>
                        ...
                        <td>
                            <div class="influencers__descripcion"><?php echo $testimonio->mensaje; ?></div>
                        </td>
                        <td>
                            <div class="influencers__acciones">
                                <form method="POST" action="/testimonios/eliminar">
                                ...
                                <a href="/testimonios/actualizar?id=<?php echo $testimonio->id; ?>" class="boton-actualizar">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
