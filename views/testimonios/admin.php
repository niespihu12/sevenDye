...
<main>
    ...
    <div class="influencers">
        ...
        <div class="influencers__header">
            <h2>Testimonios</h2>
            <a href="/testimonials/create" class="influencers__nuevo">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="influencers__acciones">
                                <form method="POST" action="/testimonials/delete">
                                ...
                                <a href="/testimonials/update?id=<?php echo $testimonio->id; ?>" class="boton-actualizar">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
